...
const base = {
  ...
  selectItemCategoryByParentId:
    "/api/goods/itemCategory/selectItemCategoryByParentId", //商品类目
...
export default {
  ...
  /* 修改商品 params={id,title, image, sellPoint, price, cid, category, num, descs, paramsInfo} */
  updateTbItem(params) {
